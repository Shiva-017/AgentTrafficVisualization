...
export default function RadarCanvas() {
  ...
  useEffect(() => {
    ...
    function drawStatic(w: number, h: number) {
      ...
      const GRID_GAP_LEN = 5;         // length of the gap between dots
    ...
    const LIFESPAN_MS = 1800;      // ms before a stroke fades out fully
    ...
    function drawAgents() {
      ...
      const ARROW_NOTCH_RATIO = -0.2;   // how deep the rear notch is, relative to length
